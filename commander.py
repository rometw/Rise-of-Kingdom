...
class Richard:
    ...
    def talent_tree(level,build):
        defense = [self.all_defense(0.5),self.all_attack(0.5),self.all_attack(0.5),self.all_attack(0.5),...
                   ...
                   self.add_rage(2),self.add_rage(2),self.add_rage(2),self.march_speed(2),self.march_speed(2),...
                   self.all_defense(0.5),self.all_defense(0.5),self.all_defense(0.5),...
                   ...
                   self.thirty_percent_rage_accum(30,25),self.thirty_percent_rage_accum(30,25)]
        infantry = 
        garrison = 
    def attack(self):
        self.skills()
